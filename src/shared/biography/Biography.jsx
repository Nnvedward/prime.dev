				...
				<div className="description">
					<p>
						<span>
							...
							build <span className="highlight">functional, scalable </span> and{" "}
							<span className="highlight">efficient web applications</span>{" "}
							using modern <span className="highlight">web technologies.</span>
						</span>
					</p>
				</div>
